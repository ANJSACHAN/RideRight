...
export default () => {
  ...
  return (
    <div className="bg-gray-900">
      <footer className="text-white bg-gray-900 px-4 py-5 max-w-screen-xl mx-auto">
        <div className="gap-6 justify-between md:flex">
          <div className="flex-1">
            <div className="max-w-xs">
              <div className="font-bold text-3xl">RideRight</div>
              <p className="leading-relaxed mt-2  text-[15px] text-[#f48c06]">
              ...
              <ul className="space-y-4" key={idx}>
                ...
                {item.items.map((el, idx) => (
                  <li key={idx}>
                    <a
                      href={el.href}
                      className="hover:underline  hover:text-[#f0bf7e]"
                    >
                      {el.name}
                    </a>
                  </li>
