...
export default function Contact() {
  return (
    <div>
     <div className="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-3 bg-gray-300">
	...
	<form novalidate="" className="space-y-6">
		...
		<button type="submit" className="w-full p-3 text-sm font-bold tracki uppercase rounded  bg-gray500 text-gray-900">Send Message</button>
	</form>
</div>
    </div>
  )
